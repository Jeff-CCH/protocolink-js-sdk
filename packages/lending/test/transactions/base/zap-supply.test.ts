...
describe('Transaction: Zap Supply', function () {
  ...
  context.only('Test Zap Supply Base', function () {
    const testCases = [
      ...
      //   protocolId: 'aave-v2',
      //   marketId: 'mainnet',
      //   srcToken: aaveV3.baseTokens.USDC,
      //   srcAmount: '100',
      //   destToken: aaveV3.baseTokens.WBTC,
      //   destAToken: aaveV2.aaveV3.baseTokens.aWBTC,
      //   expects: {
      //     logicLength: 2,
      //   },
      // },
      ...
      //   srcAmount: '100',
      //   destToken: aaveV3.baseTokens.WBTC,
      //   destAToken: radiantV2.aaveV3.baseTokens.rWBTC,
      //   expects: {
      //     logicLength: 2,
      //   },
      // },
      {
        ...
        srcToken: aaveV3.baseTokens.USDC,
        srcAmount: '100',
        destToken: aaveV3.baseTokens.USDC,
        destAToken: aaveV3.baseTokens.aBasUSDC,
      ...
      //   srcToken: aaveV3.baseTokens.USDC,
      //   srcAmount: '100',
      //   destToken: aaveV3.baseTokens.WETH,
      //   destAToken: spark.aaveV3.baseTokens.spWETH,
      //   expects: {
      //     logicLength: 2,
      //   },
      // },
      ...
      //   srcAmount: '100',
      //   destToken: aaveV3.baseTokens.WETH,
      //   destAToken: compoundV3.aaveV3.baseTokens.cWETHv3,
      //   expects: {
      //     logicLength: 2,
      //   },
      // },
